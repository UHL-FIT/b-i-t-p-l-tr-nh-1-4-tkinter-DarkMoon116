...
root.mainloop()
# 1.Nếu đổi thành root.columnconfigure(0, weight=1) thì cột 0 sẽ giãn ra và lấp đầy khoảng trống.
# 2.Vì ô nhập dữ liệu là do phía người dùng thao tác nên do đó cần có nhiều không gian phòng trường hợp người
#dùng nhập quá nhiều kí tự. Còn cột chứa là do chúng ta đã thiết lập sắn nên không cần kéo giãn.